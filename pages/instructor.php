...
<head>
    <meta charset="utf-8">
    <title>E-Learning Platform : Instructor</title>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="index.php" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <p class="m-0 fw-bold" style="font-size: 25px;"><img src="../assets/img/icon.png" alt="" height="50px">Secret<span style="color: #fb873f;">Coder</span></p> 
        </a>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-12 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Welcome to E-Learning Platform - Where Knowledge Meets Innovation</h5>
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="../assets/img/instructor-1.jpg" alt=""
                            style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    
                    <h1 class="mb-4" style="color: #fb873f;">Why Choose E-Learning Platform as Your Teaching Hub?</h1>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="../assets/img/instructor-2.jpg" alt=""
                            style="object-fit: cover;">
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    <img class="img-fluid" src="../assets/img/ready.jpg" alt="">
                </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form>
                <h5 class="mb-4">Join E-Learning Platform's Global Community
        ...
        <div class="container">
            <div class="row g-5">
                ...
                <div class="col-12 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <p>At E-Learning Platform, we believe that education has the power to transform lives. Join us in creating a world where knowledge knows no bounds, and together, let's inspire, innovate, and educate!</p>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>Sanepa, Lalitpur</p>
                    <p class="mb-2"><i class="fa fa-phone-alt me-3"></i>+977-1234567890</p>
                    <p class="mb-2"><i class="fa fa-envelope me-3"></i>eplatform@gmail.com</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">E-Learning Platform</a>, All Right Reserved.
