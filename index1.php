<?php
    include(__DIR__ . "/pages/courses_css.php");
    include(__DIR__ . "/includes/navprofile.php");
            ...
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="/project2/e_learning/assets/img/about1.jpg" alt=""
                            style="object-fit: cover;">
                    </div>
                </div>
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="section-title bg-white text-start pe-3">About Us</h6>
                    <h1 class="mb-4" style="color: #fb873f;">Welcome to E-Learning Platform</h1>
                    <p class="mb-4">At E-Learning Platform, we believe in accessible, innovative learning experiences that
                    ...
                    <p class="mb-4"> Welcom to E-Learning Platform, your gateway to boundless learning opportunities. We're
    ...
    <div class="container-xxl py-5 pt-5 bg-light">
        <div class="container">
            <div class="row g-5 ">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class="img-fluid position-absolute w-100 h-100" src="/project2/e_learning/assets/img/banner-1 (2).jpg" alt=""
                            style="object-fit: cover;">
                    </div>
                </div>
            </div>
